...
In worth-oriented domains, of which our game is one, the goals of an agent are determined by a worth function for the possible states of the environment. The obective of the agent is to maximize it's worth value.
